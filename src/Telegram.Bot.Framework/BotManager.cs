...
//    {
//        /// <summary>
//        /// Gets webhook url from bot options provided
//        /// </summary>
...
//            if (_botOptions.Webhook != null)
//            {
//                WebhookUrl = ReplaceUrlTokens(_botOptions.Webhook.Url);
//            }
//        }
...
////                    if (handler is IGameHandler gameHandler)
////                    {
...
//                    await handler.HandleAsync(null, new UpdateContext(update),
...
//                if (!string.IsNullOrWhiteSpace(_botOptions.Webhook.Certificate))
//                {
//                    var file = new FileStream(_botOptions.Webhook.Certificate, FileMode.Open);
